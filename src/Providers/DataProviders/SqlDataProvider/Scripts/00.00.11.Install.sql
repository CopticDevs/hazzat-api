...
/****** Object:  StoredProcedure [dbo].[Hymns_ServiceHymnSelectByTuneIdAndSeasonIdAndServiceHymnId]    Script Date: 1/10/2022 8:47:16 PM ******/
SET ANSI_NULLS ON
GO
...
CREATE PROCEDURE [dbo].[Hymns_ServiceHymnSelectByTuneIdAndSeasonIdAndServiceHymnId]
    @Tune_ID int,
	@Season_ID int,
	@ServiceHymn_ID int
AS 
...
/****** Object:  StoredProcedure [dbo].[Hymns_ServiceHymnSelectByTypeIdAndSeasonIdAndServiceHymnId]    Script Date: 1/10/2022 8:50:47 PM ******/
SET ANSI_NULLS ON
GO
...
CREATE PROCEDURE [dbo].[Hymns_ServiceHymnSelectByTypeIdAndSeasonIdAndServiceHymnId]
    @Type_ID int,
	@Season_ID int,
	@ServiceHymn_ID int
AS 
