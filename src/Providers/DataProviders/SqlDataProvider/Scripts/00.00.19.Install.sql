ALTER TABLE dbo.[Hymns_ServiceHymnsContent]
DROP COLUMN Info


ALTER Table dbo.[Hymns_ServiceHymnsContent]
ADD Title_Arabic [nvarchar](max) NOT NULL


/****** Object:  StoredProcedure [dbo].[Hymns_HymnContentListSelectBySeasonIdAndServiceIdAndServiceHymnIdAndFormatId]    Script Date: 5/15/2022 5:27:57 PM ******/
SET ANSI_NULLS ON
GO
...
BEGIN 
    SELECT
        ...
        [dbo].[Hymns_ServiceHymnsContent].[Title_Arabic] AS Content_Name_Arabic,
...
/****** Object:  StoredProcedure [dbo].[Hymns_HymnContentSelectBySeasonIdAndServiceIdAndServiceHymnIdAndFormatIdAndContentId]    Script Date: 5/15/2022 5:31:43 PM ******/
SET ANSI_NULLS ON
GO
...
ALTER PROCEDURE [dbo].[Hymns_HymnContentSelectBySeasonIdAndServiceIdAndServiceHymnIdAndFormatIdAndContentId]
    @Season_ID int,
    @Service_ID int,
    @ServiceHymn_ID int,
    @Format_ID int,
