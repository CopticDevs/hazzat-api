...
describe("Tunes controller", () => {
    ...
    describe("/GET all tune season service hymn format variations", () => {
        it("should get a tune season service hymn format variations (text)", (done) => {
            chai.request(server)
                .get(`/${ResourceTypes.Tunes}/14/${ResourceTypes.Seasons}/1/${ResourceTypes.Hymns}/311/${ResourceTypes.Formats}/1/${ResourceTypes.Variations}`)
                .end((err, res) => {
                    Validators.validateArrayChaiResponse(res);
                    Validators.validateTuneServiceHymnFormatVariation(res.body[0]);
                    Validators.validateTextContent(res.body[0].content);
                    done();
                });
        });

        it("should get a tune season service hymn format variations (text) with comment", (done) => {
            chai.request(server)
                .get(`/${ResourceTypes.Tunes}/14/${ResourceTypes.Seasons}/24/${ResourceTypes.Hymns}/284/${ResourceTypes.Formats}/1/${ResourceTypes.Variations}`)
                .end((err, res) => {
                    Validators.validateArrayChaiResponse(res);
                    Validators.validateTuneServiceHymnFormatVariation(res.body[0]);
                    Validators.validateTextContent(res.body[0].content);
        ...
        it("should get a tune season service hymn format variations (text) with common content", (done) => {
            chai.request(server)
                .get(`/${ResourceTypes.Tunes}/1/${ResourceTypes.Seasons}/33/${ResourceTypes.Hymns}/460/${ResourceTypes.Formats}/1/${ResourceTypes.Variations}`)
                .end((err, res) => {
                    Validators.validateArrayChaiResponse(res);
                    Validators.validateTuneServiceHymnFormatVariation(res.body[0]);
                    Validators.validateTextContent(res.body[0].content);
        ...
        it("should get a tune season service hymn format variations (text) with short reason content", (done) => {
            chai.request(server)
                .get(`/${ResourceTypes.Tunes}/12/${ResourceTypes.Seasons}/6/${ResourceTypes.Hymns}/48/${ResourceTypes.Formats}/1/${ResourceTypes.Variations}`)
                .end((err, res) => {
                    Validators.validateArrayChaiResponse(res);
                    Validators.validateTuneServiceHymnFormatVariation(res.body[0]);
                    Validators.validateTextContent(res.body[0].content);
        ...
        it("should get a tune season service hymn format variations (text) with long reason content", (done) => {
            chai.request(server)
                .get(`/${ResourceTypes.Tunes}/14/${ResourceTypes.Seasons}/1/${ResourceTypes.Hymns}/331/${ResourceTypes.Formats}/1/${ResourceTypes.Variations}`)
                .end((err, res) => {
                    Validators.validateArrayChaiResponse(res);
                    Validators.validateTuneServiceHymnFormatVariation(res.body[0]);
                    Validators.validateTextContent(res.body[0].content);
        ...
        it("should get a tune season service hymn format variations (text) with reason & common content", (done) => {
            chai.request(server)
                .get(`/${ResourceTypes.Tunes}/1/${ResourceTypes.Seasons}/33/${ResourceTypes.Hymns}/456/${ResourceTypes.Formats}/1/${ResourceTypes.Variations}`)
                .end((err, res) => {
                    Validators.validateArrayChaiResponse(res);
                    Validators.validateTuneServiceHymnFormatVariation(res.body[0]);
                    Validators.validateTextContent(res.body[0].content);
        ...
        it("should get a tune season service hymn format variations (hazzat)", (done) => {
            chai.request(server)
                .get(`/${ResourceTypes.Tunes}/14/${ResourceTypes.Seasons}/1/${ResourceTypes.Hymns}/311/${ResourceTypes.Formats}/2/${ResourceTypes.Variations}`)
                .end((err, res) => {
                    Validators.validateArrayChaiResponse(res);
                    Validators.validateTuneServiceHymnFormatVariation(res.body[0]);
        ...
        it("should get a tune season service hymn format variations (hazzat) with common content", (done) => {
            chai.request(server)
                .get(`/${ResourceTypes.Tunes}/9/${ResourceTypes.Seasons}/1/${ResourceTypes.Hymns}/377/${ResourceTypes.Formats}/2/${ResourceTypes.Variations}`)
                .end((err, res) => {
                    Validators.validateArrayChaiResponse(res);
                    Validators.validateTuneServiceHymnFormatVariation(res.body[0]);
                    Validators.validateHazzatContent(res.body[0].content);
        ...
        it("should get a tune season service hymn format variations (vertical hazzat)", (done) => {
            chai.request(server)
                .get(`/${ResourceTypes.Tunes}/1/${ResourceTypes.Seasons}/1/${ResourceTypes.Hymns}/279/${ResourceTypes.Formats}/3/${ResourceTypes.Variations}`)
                .end((err, res) => {
                    Validators.validateArrayChaiResponse(res);
                    Validators.validateTuneServiceHymnFormatVariation(res.body[0]);
        ...
        it("should get a tune season service hymn format variations (vertical hazzat) with common content", (done) => {
            chai.request(server)
                .get(`/${ResourceTypes.Tunes}/9/${ResourceTypes.Seasons}/1/${ResourceTypes.Hymns}/377/${ResourceTypes.Formats}/3/${ResourceTypes.Variations}`)
                .end((err, res) => {
                    Validators.validateArrayChaiResponse(res);
                    Validators.validateTuneServiceHymnFormatVariation(res.body[0]);
                    Validators.validateVerticalHazzatContent(res.body[0].content);
        ...
        it("should get a tune season service hymn format variations (Musical Notes)", (done) => {
            chai.request(server)
                .get(`/${ResourceTypes.Tunes}/2/${ResourceTypes.Seasons}/32/${ResourceTypes.Hymns}/334/${ResourceTypes.Formats}/4/${ResourceTypes.Variations}`)
                .end((err, res) => {
                    Validators.validateArrayChaiResponse(res);
                    Validators.validateTuneServiceHymnFormatVariation(res.body[0]);
        ...
        it("should get a tune season service hymn format variations (audio)", (done) => {
            chai.request(server)
                .get(`/${ResourceTypes.Tunes}/14/${ResourceTypes.Seasons}/14/${ResourceTypes.Hymns}/162/${ResourceTypes.Formats}/5/${ResourceTypes.Variations}`)
                .end((err, res) => {
                    Validators.validateArrayChaiResponse(res);
                    Validators.validateTuneServiceHymnFormatVariation(res.body[0]);
        ...
        it("should get a tune season service hymn format variations (video)", (done) => {
            chai.request(server)
                .get(`/${ResourceTypes.Tunes}/14/${ResourceTypes.Seasons}/14/${ResourceTypes.Hymns}/162/${ResourceTypes.Formats}/6/${ResourceTypes.Variations}`)
                .end((err, res) => {
                    Validators.validateArrayChaiResponse(res);
                    Validators.validateTuneServiceHymnFormatVariation(res.body[0]);
        ...
        it("should get a tune season service hymn format variations (information)", (done) => {
            chai.request(server)
                .get(`/${ResourceTypes.Tunes}/14/${ResourceTypes.Seasons}/14/${ResourceTypes.Hymns}/162/${ResourceTypes.Formats}/7/${ResourceTypes.Variations}`)
                .end((err, res) => {
                    Validators.validateArrayChaiResponse(res);
                    Validators.validateTuneServiceHymnFormatVariation(res.body[0]);
    ...
    describe("/GET a tune season service hymn format variation", () => {
        it("should get a tune season service hymn content (text)", (done) => {
        ...
        it("should get a tune season service hymn content (text) with comment content", (done) => {
        ...
        it("should get a tune season service hymn content (text) with common content", (done) => {
        ...
        it("should get a tune season service hymn content (text) with short reason content", (done) => {
        ...
        it("should get a tune season service hymn content (text) with long reason content", (done) => {
        ...
        it("should get a tune season service hymn content (text) with reason & common content", (done) => {
        ...
        it("should get a tune season service hymn variation (hazzat)", (done) => {
        ...
        it("should get a tune season service hymn variation (hazzat) with common content", (done) => {
        ...
        it("should get a tune season service hymn format variation (vertical hazzat)", (done) => {
        ...
        it("should get a tune season service hymn format variation (vertical hazzat) with common content", (done) => {
        ...
        it("should get a tune season service hymn format variation (Musical Notes)", (done) => {
        ...
        it("should get a tune season service hymn format variation (audio)", (done) => {
        ...
        it("should get a tune season service hymn format variation (video)", (done) => {
        ...
        it("should get a tune season service hymn format variation (information)", (done) => {
